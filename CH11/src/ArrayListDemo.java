...
{// ArrayList can't be of primitive data types (int, double, etc)
 // must be filled with objects
  ...
  public static void main(String[] args)
  {
    ...
    // change all 'dog' strings to 'doggie'
...
//    int i;
//    while ((i = animals.indexOf("dog")) >= 0)
//      animals.set(i, "doggie");
//
//    System.out.println(animals);

    // while (animals.contains("doggie"))
    // animals.remove("doggie");
    
    for (int i = animals.size()-1; i > 0; i--)
    {
      if (animals.get(i).equals("doggie"))
      {
        animals.remove(i);
      }
    }
    ...
    // show students .contains(), .indexOf(), .remove(obj)
  }
