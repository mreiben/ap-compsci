...
public class CharMatrix
{
  ...
  /**
   * Fills the given rectangle with the fill characters. row0, col0 is the upper
   * left corner and row1, col1 is the lower right corner of the rectangle.
   */
  ...
  /**
   * Fills the given rectangle with the SPACE characters. row0, col0 is the
   * upper left corner and row1, col1 is the lower right corner of the
   * rectangle.
   */
